...
insert into voter values (101,'hamza',20)
insert into voter values (102,'Anabia',24)
...
id int primary key,
name varchar(50),
city nvarchar(100) default 'key'
);

insert into person(id,name) values (101,'Rameez')
select * from person
...
create login hamza with password='hamza123'


grant select,update,insert,delete on voter to hamza

revoke select,update,insert,delete on voter to hamza